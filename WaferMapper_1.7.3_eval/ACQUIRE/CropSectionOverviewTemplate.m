function[] = CropSectionOverviewTemplate(SectionOverviewTemplateDirectory)
...
ImageFileNameStr = sprintf('%s\\SectionOverviewTemplateCroppedFilledPeriphery.tif',SectionOverviewTemplateDirectory);
