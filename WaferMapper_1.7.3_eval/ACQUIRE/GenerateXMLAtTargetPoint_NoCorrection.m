%GenerateXMLAtTargetPoint_NoCorrection
...
%     AlignmentParameters
    ...
    %read in this info
    GuiGlobalsStruct.MontageTarget.MicronsPerPixel = Info.ReadFOV_microns/Info.ImageWidthInPixels;
...
OutputXMLFileName = sprintf('%s\\FibicsStageMap.xml',GuiGlobalsStruct.WaferDirectory');
