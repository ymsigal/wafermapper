...
%%%START: NEW CODE
r_TP = GuiGlobalsStruct.MontageTarget.r - (0.5+(GuiGlobalsStruct.MontageTarget.OverviewImageHeightInPixels/2)); 
c_TP = GuiGlobalsStruct.MontageTarget.c - (0.5+(GuiGlobalsStruct.MontageTarget.OverviewImageWidthInPixels/2));
r_OA = GuiGlobalsStruct.MontageTarget.Alignment_r_offset;
c_OA = GuiGlobalsStruct.MontageTarget.Alignment_c_offset;
if isfield(GuiGlobalsStruct.MontageTarget, 'AlignedTargetList_r_offset')
