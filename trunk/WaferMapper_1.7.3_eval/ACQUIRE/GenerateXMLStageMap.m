function GenerateXMLStageMap(DirNameOfTempImageMatFiles, FilePrefixStr)
%function GenerateXMLStageMap(DirNameOfTempImageMatFiles, FilePrefixStr)
% Example: FilePrefixStr = 'TempImage_'
...
while IsMoreTempImageMatFiles
    %DataFileName = sprintf('%s\\TempImage_%d.mat',DirNameOfTempImageMatFiles, i);
    DataFileName = sprintf('%s\\%s%d.mat',DirNameOfTempImageMatFiles,FilePrefixStr, i);
